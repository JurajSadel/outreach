...
In the past six years the Rust language remained as the most "loved" programming language based on [StackOverflow statistics](https://insights.stackoverflow.com/survey/2021#most-loved-dreaded-and-wanted).
